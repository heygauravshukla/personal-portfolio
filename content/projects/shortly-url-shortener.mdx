...
img: /preview-shortly-url-shortener.webp
img_alt: Preview of Shortly - URL Shortener
description: A web application that converts long URLs into short, shareable links. Built with a focus on speed, simplicity, and mobile-first responsiveness.
